...
function ReportsPage() {
  ...
  async function loadReport() {
    try {
      const query = new URLSearchParams({ from: fromDate, to: toDate, startDate: fromDate, endDate: toDate });
