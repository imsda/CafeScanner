...
router.get('/export.csv', async (req, res) => {
  ...
  const parser = new Parser({ fields: ['timestamp', 'scannedValue', 'mealType', 'result', 'failureReason', 'stationName', 'entitlementId', 'entitlementPersonName', 'person.firstName', 'person.lastName', 'person.personId', 'person.personType'] });
